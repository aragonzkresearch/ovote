...
contract ZKMultisigTest is DSTest {
    ...
    function testNewProcessReferendum() public {
        ...
        uint256 id = zkmultisig.newProcess(2222, 1111, 1000, 1000, 100, 10, 60, 1);
        assertEq(id, 1);
        ...
        id = zkmultisig.newProcess(2222, 1111, 1000, 1000, 100, 10, 60, 1);
        assertEq(id, 2);
    ...
    function testNewProcessMultisig() public {
        // create a 1st process
        uint256 id = zkmultisig.newProcess(2222, 1111, 1000, 1000, 100, 10, 60, 0);
        assertEq(id, 1);
        ...
        // create a 2nd process with the exact same parameters
        id = zkmultisig.newProcess(2222, 1111, 1000, 1000, 100, 10, 60, 0);
        assertEq(id, 2);
        // get the process with id=2
        { // scope for process 2, avoids stack too deep errors
        (address _creator, uint256 _transactionHash, uint256 _censusRoot,
